...
type DeployConfig = schema.DeployConfig
type DeployEnvironmentConfig = schema.DeployEnvironmentConfig
type DeployCacheConfig = schema.DeployCacheConfig
type BlueGreenDeployConfig = schema.BlueGreenDeployConfig
