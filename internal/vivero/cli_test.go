...
func TestRunHelpAndSubcommandHelpAreExamplesFirst(t *testing.T) {
	...
	for _, want := range []string{"preview-first app operations for agents", "Preview:", "Evidence/debug:", "vivero preview up", "vivero evidence flow", "vivero commands --json --no-input"} {
