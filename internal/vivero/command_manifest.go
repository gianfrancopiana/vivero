...
func qaSchema() map[string]any {
	return map[string]any{
		"usage":       "vivero qa <plan|context|run|report> <preview-id> [--scope <name|all>] [--public|--target local|public|origin] --json --no-input; vivero qa record <preview-id> [--scope <name|all>] [--storage-state <path>] --json --no-input",
